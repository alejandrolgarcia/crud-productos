...
class RegistroPage extends StatelessWidget {
  ...
  Widget _crerBoton(LoginBloc bloc){
    // formValidStream
  ...
  Widget _crearFondo(BuildContext context) {
    ...
    final fondoMorado = Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: <Color>[
            const Color.fromRGBO(63, 63, 156, 1.0),
    ...
    return Stack(
      children: [
        ...
        Positioned( top: 300.0, left: -20.0, child: circulo ),
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 10.0, width: double.infinity), // Truco para centrar elementos del column 
              Text('loGo', style: TextStyle( color: Colors.white, fontSize: 25.0))
            ]
          )
        )
